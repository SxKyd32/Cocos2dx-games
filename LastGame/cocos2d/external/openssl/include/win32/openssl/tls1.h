...
# define SSL_CTX_get_tlsext_ticket_keys(ctx, keys_2, keylen) \
        SSL_CTX_ctrl((ctx),SSL_CTRL_GET_TLSEXT_TICKET_KEYS,(keylen),(keys_2))
# define SSL_CTX_set_tlsext_ticket_keys(ctx, keys_2, keylen) \
        SSL_CTX_ctrl((ctx),SSL_CTRL_SET_TLSEXT_TICKET_KEYS,(keylen),(keys_2))
