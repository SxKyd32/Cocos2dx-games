...
bool HelloWorld::init()
{
    ...
    //预加载背景音乐
    AudioEngine::preload("SNUG SPACE.mp3");
    AudioEngine::preload("Like a rabbit - Moonlight Step.mp3");
    ...
    Label* lb_title = Label::Label::createWithTTF("Break the Bricks", "fonts//Marker Felt.ttf", 50);
